function [nframes,cplot,nplot,splot,noiseplot,y,out]=omlsa10(fclean,fnoise,fin,fout)
...
[noise_in,~]=audioread([fnoise '.wav']);
[clean_in,~]=audioread([fclean '.wav']);
%% 根据实际采样频率调整参数
if fs~=fs_ref
...
nn=enframe(noise_in(23:end),nwin,inc);
cc=enframe(clean_in(23:end),nwin,inc);
nframes=size(yy,1);
