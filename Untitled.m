...
x=[0,5,10,15];
subplot(3,2,1);
plot(x,cell2mat(excel(3:3:12,2))-cell2mat(excel(2:3:11,2)),'k-');hold on;
plot(x,cell2mat(excel(4:3:13,2))-cell2mat(excel(2:3:11,2)),'b-');hold on;
plot(x,cell2mat(excel(3:3:12,2))-cell2mat(excel(2:3:11,2)),'kx');hold on;
plot(x,cell2mat(excel(4:3:13,2))-cell2mat(excel(2:3:11,2)),'bx');
xlabel('合成信噪比/dB');
ylabel('△SNR');
title('△SNR');
 
subplot(3,2,2);
plot(x,cell2mat(excel(3:3:12,3))-cell2mat(excel(2:3:11,3)),'k-');hold on;
plot(x,cell2mat(excel(4:3:13,3))-cell2mat(excel(2:3:11,3)),'b-');hold on;
plot(x,cell2mat(excel(3:3:12,3))-cell2mat(excel(2:3:11,3)),'kx');hold on;
plot(x,cell2mat(excel(4:3:13,3))-cell2mat(excel(2:3:11,3)),'bx');
...
subplot(3,2,3);
plot(x,cell2mat(excel(3:3:12,4))-cell2mat(excel(2:3:11,4)),'kx');hold on;
plot(x,cell2mat(excel(3:3:12,4))-cell2mat(excel(2:3:11,4)),'k-');hold on;
plot(x,cell2mat(excel(4:3:13,4))-cell2mat(excel(2:3:11,4)),'bx');hold on;
plot(x,cell2mat(excel(4:3:13,4))-cell2mat(excel(2:3:11,4)),'b-');
xlabel('合成信噪比/dB');
ylabel('△LLR');
title('△LLR');
 
subplot(3,2,4);
plot(x,cell2mat(excel(2:3:11,5))-cell2mat(excel(3:3:12,5)),'kx');hold on;
plot(x,cell2mat(excel(2:3:11,5))-cell2mat(excel(3:3:12,5)),'k-');hold on;
plot(x,cell2mat(excel(2:3:11,5))-cell2mat(excel(4:3:13,5)),'bx');hold on;
plot(x,cell2mat(excel(2:3:11,5))-cell2mat(excel(4:3:13,5)),'b-');
xlabel('合成信噪比/dB');
ylabel('△LSD');
title('△LSD');
 
subplot(3,2,5);
plot(x,cell2mat(excel(2:3:11,6))-cell2mat(excel(3:3:12,6)),'kx');hold on;
plot(x,cell2mat(excel(2:3:11,6))-cell2mat(excel(3:3:12,6)),'k-');hold on;
plot(x,cell2mat(excel(2:3:11,6))-cell2mat(excel(4:3:13,6)),'bx');hold on;
plot(x,cell2mat(excel(2:3:11,6))-cell2mat(excel(4:3:13,6)),'b-');
xlabel('合成信噪比/dB');
ylabel('△WSS');
title('△WSS');
 
subplot(3,2,6);
plot(x,cell2mat(excel(3:3:12,7))-cell2mat(excel(2:3:11,7)),'kx');hold on;
plot(x,cell2mat(excel(3:3:12,7))-cell2mat(excel(2:3:11,7)),'k-');hold on;
plot(x,cell2mat(excel(4:3:13,7))-cell2mat(excel(2:3:11,7)),'bx');hold on;
plot(x,cell2mat(excel(4:3:13,7))-cell2mat(excel(2:3:11,7)),'b-');
xlabel('合成信噪比/dB');
ylabel('△PESQ');
title('△PESQ');