...
omlsa3(noisy_file,enhanced2_file);
omlsa4(noisy_file,enhanced3_file);
...
subplot(3,2,1);
plot(x,cell2mat(excel(3:4:end-4,2))-cell2mat(excel(2:4:end-4,2)),'kx');hold on;
plot(x,cell2mat(excel(3:4:end-4,2))-cell2mat(excel(2:4:end-4,2)),'k-');hold on;
plot(x,cell2mat(excel(4:4:end-4,2))-cell2mat(excel(2:4:end-4,2)),'cx');hold on;
plot(x,cell2mat(excel(4:4:end-4,2))-cell2mat(excel(2:4:end-4,2)),'c-');hold on;
plot(x,cell2mat(excel(5:4:end-4,2))-cell2mat(excel(2:4:end-4,2)),'rx');hold on;
plot(x,cell2mat(excel(5:4:end-4,2))-cell2mat(excel(2:4:end-4,2)),'r-');
set(gca,'xtick',x);
...
subplot(3,2,2);
plot(x,cell2mat(excel(3:4:end-4,3))-cell2mat(excel(2:4:end-4,3)),'kx');hold on;
plot(x,cell2mat(excel(3:4:end-4,3))-cell2mat(excel(2:4:end-4,3)),'k-');hold on;
plot(x,cell2mat(excel(4:4:end-4,3))-cell2mat(excel(2:4:end-4,3)),'cx');hold on;
plot(x,cell2mat(excel(4:4:end-4,3))-cell2mat(excel(2:4:end-4,3)),'c-');hold on;
plot(x,cell2mat(excel(5:4:end-4,3))-cell2mat(excel(2:4:end-4,3)),'rx');hold on;
plot(x,cell2mat(excel(5:4:end-4,3))-cell2mat(excel(2:4:end-4,3)),'r-');
set(gca,'xtick',x);
set(gca,'xticklabel',x1);
ylabel('△SegSNR');
title('△SegSNR');
legend(' ','原始IMCRA',' ','基于语音存在概率选择搜索窗长',' ','改进最小值搜索方法');
 
subplot(3,2,3); 
plot(x,cell2mat(excel(2:4:end-4,4))-cell2mat(excel(3:4:end-4,4)),'kx');hold on;
plot(x,cell2mat(excel(2:4:end-4,4))-cell2mat(excel(3:4:end-4,4)),'k-');hold on;
plot(x,cell2mat(excel(2:4:end-4,4))-cell2mat(excel(4:4:end-4,4)),'cx');hold on;
plot(x,cell2mat(excel(2:4:end-4,4))-cell2mat(excel(4:4:end-4,4)),'c-');hold on;
plot(x,cell2mat(excel(2:4:end-4,4))-cell2mat(excel(5:4:end-4,4)),'rx');hold on;
plot(x,cell2mat(excel(2:4:end-4,4))-cell2mat(excel(5:4:end-4,4)),'r-');
set(gca,'xtick',x);
set(gca,'xticklabel',x1);
ylabel('△MSE');
title('△MSE');
...
subplot(3,2,4);
plot(x,cell2mat(excel(2:4:end-4,5))-cell2mat(excel(3:4:end-4,5)),'kx');hold on;
plot(x,cell2mat(excel(2:4:end-4,5))-cell2mat(excel(3:4:end-4,5)),'k-');hold on;
plot(x,cell2mat(excel(2:4:end-4,5))-cell2mat(excel(4:4:end-4,5)),'cx');hold on;
plot(x,cell2mat(excel(2:4:end-4,5))-cell2mat(excel(4:4:end-4,5)),'c-');hold on;
plot(x,cell2mat(excel(2:4:end-4,5))-cell2mat(excel(5:4:end-4,5)),'rx');hold on;
plot(x,cell2mat(excel(2:4:end-4,5))-cell2mat(excel(5:4:end-4,5)),'r-');
set(gca,'xtick',x);
set(gca,'xticklabel',x1);
ylabel('△LSD');
title('△LSD');
...
subplot(3,2,5);
plot(x,cell2mat(excel(3:4:end-4,6))-cell2mat(excel(2:4:end-4,6)),'kx');hold on;
plot(x,cell2mat(excel(3:4:end-4,6))-cell2mat(excel(2:4:end-4,6)),'k-');hold on;
plot(x,cell2mat(excel(4:4:end-4,6))-cell2mat(excel(2:4:end-4,6)),'cx');hold on;
plot(x,cell2mat(excel(4:4:end-4,6))-cell2mat(excel(2:4:end-4,6)),'c-');hold on;
plot(x,cell2mat(excel(5:4:end-4,6))-cell2mat(excel(2:4:end-4,6)),'rx');hold on;
plot(x,cell2mat(excel(5:4:end-4,6))-cell2mat(excel(2:4:end-4,6)),'r-');
set(gca,'xtick',x);
set(gca,'xticklabel',x1);
ylabel('△PESQ');
title('△PESQ');
...
subplot(3,2,6);
plot(x,cell2mat(excel(3:4:end-4,7))-cell2mat(excel(2:4:end-4,7)),'kx');hold on;
plot(x,cell2mat(excel(3:4:end-4,7))-cell2mat(excel(2:4:end-4,7)),'k-');hold on;
plot(x,cell2mat(excel(4:4:end-4,7))-cell2mat(excel(2:4:end-4,7)),'cx');hold on;
plot(x,cell2mat(excel(4:4:end-4,7))-cell2mat(excel(2:4:end-4,7)),'c-');hold on;
plot(x,cell2mat(excel(5:4:end-4,7))-cell2mat(excel(2:4:end-4,7)),'rx');hold on;
plot(x,cell2mat(excel(5:4:end-4,7))-cell2mat(excel(2:4:end-4,7)),'r-');
set(gca,'xtick',x);
set(gca,'xticklabel',x1);
ylabel('△STOI');
title('△STOI');
